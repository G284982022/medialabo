let data = [
  ...
  let phototableElement = document.getElementById('phototable');
  
  phototableElement.appendChild(pE1);
  phototableElement.appendChild(pE2);
  phototableElement.appendChild(pE3);
